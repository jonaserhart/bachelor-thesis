...
This thesis explores the importance of having a comprehensive set of KPIs for agile teams, focusing on identifying the essential KPIs for evaluating team performance in the SCRUM.
A research question is to find out if such a set of essential KPIs can be defined or if teams would benefit from more customized KPIs for their sprints.
A collaboration with a company will be made to develop an application.
