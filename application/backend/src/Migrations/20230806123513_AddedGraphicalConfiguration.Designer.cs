...
namespace backend.Migrations
{
    ...
    [Migration("20230806123513_AddedGraphicalConfiguration")]
    partial class AddedGraphicalConfiguration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Model.Analysis.AnalysisModelConfiguration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AnalysisModelConfiguration");
                });
            ...
            modelBuilder.Entity("backend.Model.Analysis.Graphical.GraphicalConfiguration", b =>
                {
                    ...
                    b.ToTable("GraphicalConfiguration");
                });
            ...
            modelBuilder.Entity("backend.Model.Analysis.AnalysisModel", b =>
                {
                    b.HasOne("backend.Model.Analysis.AnalysisModelConfiguration", "Configuration")
                        .WithMany()
            ...
            modelBuilder.Entity("backend.Model.Analysis.Graphical.GraphicalReportItem", b =>
                {
                    ...
                    b.OwnsOne("backend.Model.Analysis.Graphical.GraphicalReportItemLayout", "Layout", b1 =>
                        {
                            b1.Property<Guid>("GraphicalReportItemId")
                                .HasColumnType("uuid");

                            b1.Property<int>("H")
                                .HasColumnType("integer");

                            b1.Property<string>("I")
                                .IsRequired()
                                .HasColumnType("text");
                            ...
                            b1.HasKey("GraphicalReportItemId");

                            b1.ToTable("GraphicalReportItem");

                            b1.WithOwner()
                                .HasForeignKey("GraphicalReportItemId");
                        });
