...
namespace backend.Migrations
{
    ...
    [Migration("20231011134526_AddedListLabels")]
    partial class AddedListLabels
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Model.Analysis.Graphical.GraphicalReportItemProperties", b =>
                {
                    ...
                    b.Property<string>("ListFieldsWithLabels")
                        .IsRequired()
                        .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("backend.Model.Analysis.Reports.Report", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("backend.Model.Analysis.Reports.ReportData", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("backend.Model.Analysis.Expressions.ListIfMultipleExpression", b =>
                {
                    b.HasBaseType("backend.Model.Analysis.Expressions.DoIfMultipleExpression");
            ...
            modelBuilder.Entity("backend.Model.Analysis.Reports.ReportData", b =>
                {
                    b.HasOne("backend.Model.Analysis.Reports.Report", "Report")
                        .WithOne("ReportData")
                        .HasForeignKey("backend.Model.Analysis.Reports.ReportData", "ReportId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
